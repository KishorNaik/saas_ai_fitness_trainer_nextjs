            ...
            <div className="mb-10 relative backdrop-blur-sm border border-border p-6">
                ...
                <div className="flex flex-col md:flex-row items-center md:items-center gap-6">
                    <div className="relative">
                        {user.imageUrl ? (
                            <div className="relative w-24 h-24 overflow-hidden rounding-lg">
                                <Image src={user.imageUrl} alt={user.fullName || "profile"} width={40} height={40} className="w-full h-full object-cover"/>
                            </div>
                        ) : (
